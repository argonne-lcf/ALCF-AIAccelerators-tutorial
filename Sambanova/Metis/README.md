...
[Metis](https://docs.alcf.anl.gov/ai-testbed/sn40l_inference/) is composed of four SambaRacks—each housing 16 SN40L RDU systems. This dedicated setup delivers high-throughput, low-latency performance for machine learning workloads. 
...
The list of currently supported chat-completion models on Metis are : gpt-oss-120b and Llama-4-Maverick.
